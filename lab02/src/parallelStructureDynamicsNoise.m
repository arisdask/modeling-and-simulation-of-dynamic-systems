function dydt = parallelStructureDynamicsNoise(t, y, m_true, b_true, k_true, gamma1, gamma2, gamma3, n0, f0)
    ...
    % Parameter adaptation laws (unaffected by noise since using x_hat)
    dtheta = zeros(3,1);
